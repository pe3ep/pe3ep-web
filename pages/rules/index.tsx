  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.pe3ep.ru/rules" />
        ...
        <div className="bg-zinc-900/50 py-8">
          <div className="container mx-auto">
            ...
            <div className="flex mx-8 md:mx-auto flex-col gap-3 text-center max-w-3xl">
              ...
              <p className="leading-5 lg:text-lg">
                Запрещено выдавать себя за другое лицо (введение в заблуждение).
              </p>
              <p className="leading-5 lg:text-lg">
          ...
          <div className="container mx-auto">
            ...
            <div className="flex mx-8 md:mx-auto flex-col gap-3 text-center max-w-3xl">
              <p className="leading-5 lg:text-lg">
                ...
                распространяемый через Twitch чат, в том числе и на контент,
